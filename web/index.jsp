        ...
        <td bgcolor="#005FC6">
            ...
            <TABLE height=9 cellSpacing=0 cellPadding=0 width=100% align=center border=0>
                ...
                <TR>
                        ...
                        <TABLE height=425 cellSpacing=0 cellPadding=0 width=760 align=center border=0>
                            ...
                            <TR>
                                ...
                                <TD vAlign=top width=202 bgColor=#ffffff>
                                    <TABLE height=147 cellSpacing=0 cellPadding=0 width=200 border=0>
                                        <TBODY>
                                        <TR>
                                            <TD width=18 height=25><IMG height=25 src="<%=path %>/images/1825.gif"
                                                                        width=18></TD>
                                            <TD class=sl width=164 background="<%=path %>/images/su.gif" height=25>
                                                <DIV class=leon>
                                        ...
                                        <TR vAlign=bottom>
                                            <TD background="<%=path %>/images/hdw.gif" colSpan=3 height=112>
                                                <FORM name=form action="/Manager/LoginServlet" method=post id="from">
                                                    <TABLE height=69 width=176 align=center border=0>
                                                        ...
                                                        <TR>
                                                            ...
                                                            <TD background="<%=path %>/images/sr.gif" height=20>
                                                                <INPUT
                                                                        class=hui2
                                                                        ...
                                                                        tabIndex=1 type=password size=15
                                                                        name="password">
                                                            </TD>
                                                        </TR>
                                                        <TR>
                              ...
                              </FONT></SPAN></FONT><a href="javascript:submitForm()">
                                                                <img src="<%=path %>/images/dl-1.gif"
                                                                                      name="Image7" width="60"
                  ...
                  <br>
                  <span class="STYLE7"><IMG height=10
                                            src="<%=path %>/images/jt2.gif" width=10> duanzp建议如下：[应用时，请将此行(包括此行)以下的红色字体部分删除！]</span>根据要求前台以完成！<br>
                  <br>
            注：尽量不要改变WEB页中图片的路径位置，图片位于images文件夹中。包括样式的定义也不要改变！
            一但改变，如果路经指定不完整，会出现在样式丢失，影响整体WEB的美观，对于我本人的再次修也比较复杂。对于一个网站来说，所有的图片、样式及其它修饰WEB页的部分，都应位于此网站的根目录下。不应该超出根以外的目录、文件夹或路径。<br>
            <br>
            ※
            所有图片的位置及样式路径的定义，是按照WEB设计通用习惯及后期维护方便等行式定义的。</span></TD>
                                <TD>&nbsp;</TD>
                                <TD valign="top"><br>
