...
<script type="text/javascript">
  function dosubmit(){
    ...
    th.action="<%=path%>/product/2_1_5xg.jsp";
    th.submit();
  }
</script>
</HEAD>
      ...
      <TBODY>
        ...
        border=0 cellPadding=4 cellSpacing=1 bgColor=#0867b3>
              <TBODY>
                <TR bgColor=#ffffff height=20>
                  <% List<String>list= (List<String>) request.getAttribute("newInfo");

                  %>
                  <TD width=13% align="center"  noWrap class="STYLE7">产品名称</TD>
                  <TD width=31% noWrap><span class="foot3"><%= list.get(0)%></span></TD>
                ...
                <TR bgColor=#ffffff height=20>
                  ...
                  <% String file= (String) request.getAttribute("imagePath"); %>
                  <TD height="-1" colspan="3" valign="middle" noWrap><img src="<%=path %>/upload/<%=file%>" /></TD>
                  </TR>
              </TBODY>
            </TABLE>
              <br></TD>
        ...
        <TR>
          <TD height=27 colspan="2" align="center" vAlign=top>
            <a href="javascript:dosubmit();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','<%=path %>/images/ok_2.jpg',1)"><img src="<%=path %>/images/ok_1.jpg" name="Image3" width="60" height="22" border="0"></a>  <a href="javascript:history.back();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','<%=path %>/images/fh_2.jpg',1)"><img src="<%=path %>/images/fh_1.jpg" name="Image4" width="60" height="22" border="0"></a></TD>
        </TR>
        <TR>
